...
export interface Prisma {
  ...
  userCommunitiesConnection: (args?: {
    where?: UserCommunityWhereInput;
    orderBy?: UserCommunityOrderByInput;
    skip?: Int;
    after?: String;
  ...
  updateUserChannel: (args: {
    data: UserChannelUpdateInput;
    where: UserChannelWhereUniqueInput;
  }) => UserChannelPromise;
  updateManyUserChannels: (args: {
    data: UserChannelUpdateManyMutationInput;
    where?: UserChannelWhereInput;
  }) => BatchPayloadPromise;
  upsertUserChannel: (args: {
    where: UserChannelWhereUniqueInput;
